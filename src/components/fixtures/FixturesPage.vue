...
import CurrentDate from './header/CurrentDate.vue'
import Calendar from './header/Calendar.vue'
import PeriodsList from './header/PeriodsList.vue'
import ErrorOutput from '../shared/ErrorOutput.vue'
import Loader from '../shared/Loader.vue'
import { generateDateString, generatePeriods, filterResolvedPromises } from '../../helpers/fixtures'
    ...
    async getFixturesData () {
      ...
      try {
        ...
        if (filteredResponses.length) {
          this.fixturesData = filteredResponses
